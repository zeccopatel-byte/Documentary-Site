  ...
  return (
    <div className="w-full pt-32 pb-24 bg-background min-h-screen">
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <h1 className="font-serif text-5xl md:text-7xl mb-8">About the Project</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 mb-32">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="font-serif text-4xl mb-8 text-primary">Why We Film</h2>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h2 className="font-serif text-4xl mb-8 text-primary">Ethical Storytelling</h2>
            <ul className="space-y-6">
              <li className="flex gap-4">
                <span className="font-serif text-2xl text-foreground/30">01</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-serif text-2xl text-foreground/30">02</span>
                <div>
              ...
              <li className="flex gap-4">
                <span className="font-serif text-2xl text-foreground/30">03</span>
                <div>
        ...
        <motion.div
          ...
          className="mb-32"
        >
          <h2 className="font-serif text-5xl mb-16 text-center">The Team</h2>
        ...
        >
          <h2 className="font-serif text-3xl mb-12 text-foreground/50">Supported By</h2>
          <div className="flex flex-wrap justify-center items-center gap-16 opacity-40 grayscale">
            {/* Placeholders for partner logos */}
            <div className="text-2xl font-serif font-bold">Global Film Fund</div>
            <div className="text-2xl font-sans font-black tracking-tighter">HUMAN RIGHTS WATCH</div>
            <div className="text-2xl font-serif italic">The Documentary Institute</div>
